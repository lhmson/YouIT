  ...
  #removeUserInstance = (userId) => {
    if (userId) {
      ...
      if (this.#statusInfoOfUsers[userId]) {
        ...
        this.#statusInfoOfUsers[userId].actualStatus = this.#statusInfoOfUsers[userId].countIntances ? "online" : "offline";
      }
  ...
  getUserStatus = (userId) => {
    if (userId && this.#statusInfoOfUsers[userId]) {
      ...
      if (this.#statusInfoOfUsers[userId].lockedStatus)
        ...
        return this.#statusInfoOfUsers[userId].actualStatus;
    } else
      return "offline";
  }
